//Variable que inicializaremos para que mantenga el estado visible del carrito
...
function pagarClicked() {
    ...
    // Mostramos el mensaje de compra completada
    var mensajeCompraCompletada = document.getElementById('mensajeCompraCompletada');
    mensajeCompraCompletada.style.display = 'block';

    // Ocultamos el mensaje después de 3 segundos (3000 milisegundos)
    setTimeout(function () {
        mensajeCompraCompletada.style.display = 'none';
    }, 3000);
}
        ...
        <div class="carrito-item">
            ...
            <div class="carrito-item-detalles">
                ...
                <div class="selector-cantidad">
                    <svg  class="fa-solid fa-minus restar-cantidad"xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M432 256c0 17.7-14.3 32-32 32L48 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l352 0c17.7 0 32 14.3 32 32z"/></svg>
                    <input type="text" value="1" class="carrito-item-cantidad" disabled>
                    <svg class="fa-solid fa-plus sumar-cantidad" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. --><path d="M256 80c0-17.7-14.3-32-32-32s-32 14.3-32 32V224H48c-17.7 0-32 14.3-32 32s14.3 32 32 32H192V432c0 17.7 14.3 32 32 32s32-14.3 32-32V288H400c17.7 0 32-14.3 32-32s-14.3-32-32-32H256V80z"/></svg>
                </div>
